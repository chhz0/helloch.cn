...
---
# Redis 数据结构 <Badge type="tip" text="Redis Data Types" />
...
对于Redis详细的数据结构，可以参考[Redis/data-types](https://redis.io/docs/latest/develop/data-types/).

## Redis Object 结构

Redis是kv存储，key和value在Redis中被抽象成对于(Object)，key只能是**String**对象，value支持丰富的对象类型，即上述的Redis数据结构.
